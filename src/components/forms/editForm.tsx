...
import {addUsers, editUsers} from "../../service/API"
...
export default function UserForm({ user, onSubmit, onCancel,setFlag,flag}: UserFormProps) {
  ...
  const onFormSubmit = async(data: User) => {
    ...
    await editUsers(formattedData.id,formattedData);
    setFlag(!flag)
  };
